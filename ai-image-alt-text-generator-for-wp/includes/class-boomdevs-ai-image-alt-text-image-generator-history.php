...
class AI_Alt_Text_History_Table extends WP_List_Table
{
    ...
    public function column_default($item, $column_name)
    {
        switch ($column_name) {
            case 'media_id':
                return sprintf('<h3 style="color: #2271b1">' . esc_html($item['attachment_id']) . '</h3>');
            ...
            case 'gen_text':
                return sprintf('<textarea class="alt-text" style="width: 100%%; max-height: 130px; min-height: 60px; border-color: #e3e3e3; resize: vertical;">%s</textarea>', esc_textarea($item['gen_text']));
    ...
    {
        $actions = [
            'edit' => '<button class="button button-primary update-alt" data-media-id="' . esc_attr($item['attachment_id']) . '">Update</button><span class="update-message"></span>',
            'view' => '<a class="button-secondary button-large" href="' . esc_url(wp_get_attachment_url($item['attachment_id'])) . '" target="_blank">View</a>',
        ];
